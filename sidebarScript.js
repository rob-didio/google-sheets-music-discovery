function runSpotSidebar() {
  ...
  */
  ...
  let frame = `<iframe src="https://open.spotify.com/embed/artist/${artistID}"
   width="290" height="550" frameborder="0" allowtransparency="true"
...
function runBandcampSidebar() {
  ...
  */
  ...
  let frame = `<iframe style="border: 0; width: 290px; height: 470px;"
   src="https://bandcamp.com/EmbeddedPlayer/album=3634738664/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/"
    seamless><a href="${bcURL}"></a></iframe>`;
